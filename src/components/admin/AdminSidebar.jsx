...
const AdminSidebar = () => {
    ...
    return (
        <div className="w-64 h-screen bg-white dark:bg-slate-900 text-gray-800 dark:text-slate-200 flex flex-col fixed left-0 top-0 border-r border-gray-100 dark:border-slate-800 shadow-sm transition-colors duration-300">
            {/* Logo Section */}
            <div className="p-8 border-b border-gray-50 dark:border-slate-800">
                ...
                <p className="text-[10px] text-gray-400 dark:text-slate-500 uppercase tracking-widest mt-1 font-bold">Admin Portal</p>
            </div>
            ...
            <div className="p-4 border-t border-gray-50 dark:border-slate-800">
                <button
                    onClick={() => navigate("/")}
                    className="flex items-center gap-3 w-full px-4 py-3 text-gray-500 dark:text-slate-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-500 rounded-xl transition-all group font-semibold text-sm cursor-pointer"
                >
