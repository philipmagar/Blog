                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right">
                            <p className="text-sm font-bold text-gray-800 dark:text-slate-200 leading-none">Philip Magar</p>
                            <p className="text-[10px] text-gray-400 dark:text-slate-500 mt-1 uppercase tracking-tighter">Super Administrator</p>
                        </div>
